...
namespace Compori.Shipping.Dhl.ParcelShipment.Types
{
    ...
    /// 
    /// Combines name, address, contact information. The recommended way is to use the mandatory attribute addressStreet
    /// and submit the streetname and housenumber together â€“ alternatively addressHouse + addressStreet can be used. 
    /// For many international addresses there is no house number, please do not set a period or any other sign to indicate
    /// that the address does not have a housenumber.
    ...
    public class ContactAddress : Consignee
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets optional, additional line of address. 
        /// It's only usable for a few countries, e.g. Belgium. It is positioned below name3 on the label.
        /// value:min:1, max:35
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets Line 1 of the street address. This is just the street name. Can also include house number.
        /// value:min:1, max:50
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the state, province or territory. For the USA please use the official regional ISO-Codes, e.g. US-AL.
        /// value:min:1, max:20
        /// </summary>
        ...
        /// forward their phone number to Deutsche Post DHL Group. For shipments within Germany, the phone number cannot be transmitted.
        /// In some countries the provision of a telephone number and/or e-mail address is mandatory for a delivery to a droppoint. 
        ...
        /// Please note that, in accordance with Art. 4 No. 11 GDPR, you must obtain the recipient's consent to forward 
        /// their e-mail address to Deutsche Post DHL Group. 
        /// For shipments within Germany, the e-mail address is used to send a DHL Parcel Notification to the recipient. 
        /// The e-mail address is not mandatory for shipments within Germany. 
        /// In some countries the provision of a telephone number and/or e-mail address is mandatory for a delivery to a droppoint. 
        /// If your recipient has objected to the disclosure of their telephone number and/or e-mail address, 
        /// the shipment can only be delivered in these countries using the service Premium.
        /// value:min:3, max:80
